...
window.onload = function () {
    ...
    infancia.onmouseover = function () { document.getElementById("infancia").innerHTML = "Infancia"; };
    ...
    filmografia.onmouseover = function () { document.getElementById("filmografia").innerHTML = "Filmografía"; };
    ...
    politico.onmouseover = function () { document.getElementById("politico").innerHTML = "Político"; };
    ...
    compositor.onmouseover = function () { document.getElementById("compositor").innerHTML = "Compositor"; };
    compositor.onmouseout = function () {
        document.getElementById("compositor").innerHTML = "Ver";
    };

    var exilio = document.getElementById("exilio");
    exilio.onmouseover = function () { document.getElementById("exilio").innerHTML = "Exilio"; };
    exilio.onmouseout = function () {
        document.getElementById("exilio").innerHTML = "Ver";
    };

    var familia = document.getElementById("familia");
    familia.onmouseover = function () { document.getElementById("familia").innerHTML = "Familia"; };
